...
async def run_backtest(args):
    ...
    with debug_context("Standard backtest execution") as context:
        ...
        if result:
            ...
            debug_variable("result_starting_balance", result.starting_balance, context)
            debug_variable("result_ending_balance", result.ending_balance, context)
            ...
            print(f"Initial Balance:  ${result.starting_balance:,.2f}")
